// This uses production URL and needs also a client key
// let BASE_URL = "https://aiwizzard.vercel.app/api/enhance";

let BASE_URL = 'http://localhost:5000/backend';
// let CLIENT_KEY =
...
function loadStyle() {
  ...
  // TODO - Add your custom CSS rules here
...
window.onload = function () {
  ...
  inputElements.forEach(function (inputElement) {
    ...
    // inputElement.addEventListener('dragStart', function () {
